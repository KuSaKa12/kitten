...
async def cmd_start(message: Message, state: FSMContext):
    ...
    rules_text = (
        ...
        "👇 <i>Нажимая кнопку ниже, ты подтверждаешь, что принимаешь <a href='ССЫЛКА_НА_СОГЛАШЕНИЕ'>Пользовательское соглашение</a> и <a href='https://docs.google.com/document/d/1Z99gTfiVyo3CaDZXbqSJ1lsqw2Rp3VuvjjdojzZWTQw/edit?usp=sharing'>Политику конфиденциальности</a>, и готов(а) соблюдать правила сервиса!</i>"
    )
    await message.answer(
        rules_text, 
